...
class Backbone(nn.Module):
    ...
    def __init__(self, downsample_factor):
        ...
        if downsample_factor == 8:
            ...
            raise ValueError('backbone.py: output stride=%d is not supported.' % os)
...
def backbone(pretrained=True, downsample_factor=16):
    model = Backbone(downsample_factor=downsample_factor)
    return model
